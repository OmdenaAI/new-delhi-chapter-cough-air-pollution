...
<thead><tr><th scope="col">Task Name</th><th scope="col">Task Lead</th><th scope="col">Active Contributors</th></tr></thead>
         <tbody>
         <tr><td scope="row">Knowledge</td><td>Eishani Bhattacharya,  Anushka Singh,Param Barodia </td><td>Param Barodia</td></tr>
          ...
          <tr><td scope="row">Model Development</td><td>Pankaj Tiwari, Zuhail, Shibendra Bhattacharjee</td><td>Shibendra Bhattacharjee</td></tr>
          <tr><td scope="row">Model Deployment API Creation</td><td>Arya Adesh, Vinod Cherian</td><td>Vinod Cherian</td></tr>
          <tr><td scope="row">Web Portal Creation</td><td>Harshita, Arya Adesh</td><td>Harshita, Vinod Cherian</td></tr>
          <tr><td scope="row">Making the Web Portal Live</td><td>Vinod Cherian</td><td>Vinod Cherian</td></tr>
         </tbody>
         </table>
</div>

<!-- Container (Data Source Section) -->
<div id="datasource" class="container-fluid text-center bg-black">
  <h2>Data Source</h2>
